        ...
        for date_item in datelist:
            ...
            if alltx_stats != None:
                ...
                if dhs_stats != None:
                    ...
                    texas_test_stats.update({'Antigen_Pos': dhs_stats.get('LAB_Positivity')})
                    texas_test_stats.update({'LAB_Positives': dhs_stats.get('LAB_Positives')})
                    texas_test_stats.update({'LAB_Pos7Day': dhs_stats.get('LAB_Positive7Day')})
                    texas_test_stats.update({'LAB_Test7Day': dhs_stats.get('LAB_Test7Day')})
                    texas_test_stats.update({'LAB_Total': dhs_stats.get('LAB_Tests')})                
                    texas_test_stats.update({'PCR_Pos': dhs_stats.get('SEPCIMEN_Positivity')})
                    texas_test_stats.update({'SPEC_Old': dhs_stats.get('SEPCIMEN_OldPositive')})
                    texas_test_stats.update({'SPEC_Positives': dhs_stats.get('SEPCIMEN_NewPositive')})
                    texas_test_stats.update({'SPEC_Pos7Day': dhs_stats.get('SPECIMEN_TestPositive7Day')})
                    texas_test_stats.update({'SPEC_Test7Day': dhs_stats.get('SPECIMEN_Test7Day')})
